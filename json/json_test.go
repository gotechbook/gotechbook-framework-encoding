...
func TestJSONMarshal(t *testing.T) {
	tests := []struct {
		...
		{
			input:  &encoding.TestModel{Id: 1, Name: "go-tech-book-framework-encoding", Hobby: []string{"1", "2"}, Attrs: map[string]string{}},
			expect: `{"id":"1","name":"go-tech-book-framework-encoding","hobby":["1","2"],"attrs":{}}`,
		},
		{
...
func TestJSONUnmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		{
			input:  `{"id":"1","name":"go-tech-book-framework-encoding","hobby":["1","2"],"attrs":{}}`,
			expect: &p2,
		},
		{
			input:  `{"id":1,"name":"go-tech-book-framework-encoding","hobby":["1","2"]}`,
			expect: &p3,
		},
		{
			input:  `"zebra"`,
